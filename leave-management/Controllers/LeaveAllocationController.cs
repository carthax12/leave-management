...
namespace leave_management.Controllers
{
    ...
    public class LeaveAllocationController : Controller
    {
        ...
        public ActionResult Index(int updated = 0)
        {
        ...
        public ActionResult SetLeave(int id)
        {
            ...
            foreach (var emp in employees)
            {
                ...
                var allocation = new LeaveAllocationsVM
                {
            ...
            return RedirectToAction("Index", "LeaveAllocation", new { updated });
        }
        ...
        public ActionResult Details(string id)
        {
            ...
            var allocations = _mapper.Map<List<LeaveAllocationsVM>>(_leaveallocationrepo.GetLeaveAllocationsByEmployee(id));
